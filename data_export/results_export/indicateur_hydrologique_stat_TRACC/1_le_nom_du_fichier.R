...
NCf$title.06.dataset = "TRACC-2023"
...
if (is_SAFRAN) {
    ...
    NCf$title.09.GCM_Model = meta_projection$gcm_short[projection_ok]
}
...
if (is_SAFRAN) {
    ...
    NCf$title.10.RCM_Model = meta_projection$rcm_short[projection_ok] 
}

## 11. HYDRO-Inst-Model _______________________________________________
# Identifiant du HYDRO = Institut-Modèle
NCf$title.11.HYDRO_Inst_Model = "ENSavg"# dataEX$HM[1]
