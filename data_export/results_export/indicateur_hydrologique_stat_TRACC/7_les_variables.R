...
assign(paste0(metaEX_var$variable_en, ".01.standard_name"),
       variable_standard_name, envir=NCf)
assign(paste0(metaEX_var$variable_en, ".02.long_name"),
       metaEX_var$name_en, envir=NCf)
assign(paste0(metaEX_var$variable_en, ".03.method_WL"),
       "TRACC-2023", envir=NCf)
assign(paste0(metaEX_var$variable_en, ".04.units"),
       gsub("([\\^])|([{])|([}])", "", metaEX_var$unit_en), envir=NCf)
assign(paste0(metaEX_var$variable_en, ".05.missing_value"),
       NaN, envir=NCf)
assign(paste0(metaEX_var$variable_en, ".06.comment"),
       metaEX_var$method_en, envir=NCf)
