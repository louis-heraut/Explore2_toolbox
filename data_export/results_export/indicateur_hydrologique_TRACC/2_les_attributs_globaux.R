...
NCf$global.44.indicator_time_central_year = central_year #Calculer dans Drias_Export
...
NCf$global.45.version_spec_format = "spécifications - version du 2025-05-13"
